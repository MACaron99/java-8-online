...
public class Handshake {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("In this program, connections between 36000 objects are randomly formed so that the " +
                "maximum distance between objects is 6 handshakes.");
        System.out.println("You can specify initial and the final objects between which the program needs to find " +
                "the shortest path.");
        System.out.println();
        ...
        if (shortestPath == -1) {
            ...
            System.out.println("Shortest path between " + startId + " and " + endId + ": " + shortestPath +
                    " handshakes");
        }
    }
